...
class TeenageMutantNinjaTurtlesTournamentFighters(gym.Wrapper):
    def __init__(self, env, reset_round=True, rendering=False):
        super(TeenageMutantNinjaTurtlesTournamentFighters, self).__init__(env)
        self.env = env
