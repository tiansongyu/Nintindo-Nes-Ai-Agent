...
def make_env(game, state, seed=0):
    def _init():
        ...
        env = RushnAttack(env,True,IsRender)
        env = Monitor(env)
        env.seed(seed)
        return env
    return _init
...
def main():
    ...
    checkpoint_callback = CheckpointCallback(save_freq=checkpoint_interval, save_path=save_dir, name_prefix="ppo_RushnAttack")
    ...
    model.save(os.path.join(save_dir, "ppo_rushattack_final.zip"))
